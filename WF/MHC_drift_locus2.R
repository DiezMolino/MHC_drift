...
title(main ='Exon 2 | 11 polymorphic positions', cex.main=1.5, ylab= "Population size at bottleneck", xlab= "Population size after bottleneck", 
      cex.lab=0.8)
box()
...
mtext(text='Probability of observing 8 or more polymorphisms', side=4, line=1)
