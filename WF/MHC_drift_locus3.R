...
freq.init = c(0.125, 0.16667, 0.29167, 0.29167, 0.29167, 0.08333, 0.04167, 0.08333)
...
title(main =paste0('Intron 2a | ', n.polymor,' polymorphic positions'), cex.main=1.5, ylab= "Population size at bottleneck", xlab= "Population size after bottleneck", 
      cex.lab=0.8)
box()
